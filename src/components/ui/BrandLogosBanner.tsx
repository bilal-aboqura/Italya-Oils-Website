...
export default function BrandLogosBanner({ logos }: BrandLogosBannerProps) {
  ...
  return (
    <section className="py-12 relative bg-slate-50 border-y border-slate-200 overflow-hidden grid-pattern">
      ...
      <div className="relative flex w-full gap-12 group overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] z-10 py-4">
        {/* First track */}
